...
%.zip:
	...
	npm run build
	mkdir -p nodejs
	npm install --prefix nodejs/ puppeteer-core@19 tar-fs@2.1.1 follow-redirects@1.15.2 --bin-links=false --fund=false --omit=optional --omit=dev --package-lock=false --save=false
	npm pack
